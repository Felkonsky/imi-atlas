...
(function (global, factory) {
    ...
    function started(event) {
      ...
      if (type === 'overlay') {
        ...
        state.selection = selection = [
          ...
          [(e0 = dim === Y ? E : max$2(pts[0][0], pts[1][0])), (s0 = dim === X ? S : max$2(pts[0][1], pts[1][1]))],
        ];
  ...
  function projectionMutator(projectAt) {
    ...
    projection.clipExtent = function (_) {
      return arguments.length
        ? ((postclip = _ == null ? ((x0 = y0 = x1 = y1 = null), identity$5) : clipRectangle((x0 = +_[0][0]), (y0 = +_[0][1]), (x1 = +_[1][0]), (y1 = +_[1][1]))), reset())
        : x0 == null
        ? null
        : [
            [x0, y0],
