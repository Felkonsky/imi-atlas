...
with app.app_context():
    ...
    # Elemente pro Kategorie definieren (Kategorien können hinzugefügt/entfernt werden in 'models.py', dann müssen auch db queries in 'routes.py' aktualisiert werden)
    ...
    # Ausstellungen zur db session hinzufügen
    ...
    db.session.add_all([media_station_0,])
    db.session.commit()
